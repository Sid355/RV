xs2kn='eyJ0eXAiOiJKV1QiLCJrZXlfaWQiOiJza192MS4wIiwiYWxnIjoiSFMyNTYifQ.eyJzdWIiOiI4TEFKRzkiLCJqdGkiOiI2Nzc0YzIzMjMzMjRmZTUwYTZlNzJlZDkiLCJpc011bHRpQ2xpZW50IjpmYWxzZSwiaWF0IjoxNzM1NzA1MTM4LCJpc3MiOiJ1ZGFwaS1nYXRld2F5LXNlcnZpY2UiLCJleHAiOjE3MzU3Njg4MDB9.RqG_FrpERo22YLnOsleebyAMrcb1_tt5XCxYwp5JTKg'
...
def panda():
    import pandas as pd
    # Read the CSV file
    data = pd.read_csv("E:/RV/saitama/Deep_storage/SME_EQUITY_L.csv")
    ...
    for n in range(0,len(data['ISIN_NUMBER'])):                 ################ -2030
       c_isin=data['ISIN_NUMBER'][n]
       c_symbol=data['SYMBOL'][n]
       file_name=c_symbol+'_'+c_isin+'.txt'

       file_path = "E:/RV/saitama/Deep_storage/SME_storage/"+file_name
